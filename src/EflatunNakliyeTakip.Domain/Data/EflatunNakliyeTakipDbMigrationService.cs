...
{
    public class EflatunNakliyeTakipDbMigrationService : ITransientDependency
    {
        public ILogger<EflatunNakliyeTakipDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IEflatunNakliyeTakipDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public EflatunNakliyeTakipDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IEflatunNakliyeTakipDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<EflatunNakliyeTakipDbMigrationService>.Instance;
        }
